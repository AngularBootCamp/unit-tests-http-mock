# Angular Boot Camp example: unit-tests-http-mock
...
**[StackBlitz for unit-tests-http-mock](https://stackblitz.io/github/AngularBootCamp/unit-tests-http-mock)**

Alternatively, you can clone the repository locally to run the example:

```
git clone git@github.com:AngularBootCamp/unit-tests-http-mock.git
cd unit-tests-http-mock
npm install
npm start
```
