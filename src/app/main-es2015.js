...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 17, vars: 3, consts: [["href", "test.html"], [1, "btn"], ["href", "https://developers.livechatinc.com/blog/angular-dependency-injection-components/"], ["href", "https://angular.io/guide/testing"], [1, "card"], [1, "card-content"], [1, "card-title"], [4, "ngFor", "ngForOf"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
...
const apiUrl = _environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl;
class EmployeeService {
    constructor(http) {
        this.http = http;
    }
    getList() {
        return this.http.get(apiUrl + '/employees').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(employees => employees.map(e => e.first_name)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(names => names.sort()), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(err => {
...
EmployeeService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({ token: EmployeeService, factory: function (t) { return EmployeeService.ɵfac(t); }, providedIn: 'root' });
/*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](EmployeeService, [{
